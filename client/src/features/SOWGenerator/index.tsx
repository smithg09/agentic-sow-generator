...
const SOWGenerator = () => {
  ...
  return (
    <div className="min-h-[600px] h-[calc(100vh-4rem)]">
                      ...
                      <>
                        {generatedContent && (
                          <>
                            ...
                            <img src={theme === 'dark' ? '/letter-head-white.png' : '/letter-head.png'} width="200" height="100" className="mb-6" />
                            <MarkdownPreview
                              wrapperElement={{
                ...
                <div className="mt-4 rounded-lg flex flex-col max-h-[10rem]">
                    ...
                    <div className="flex gap-2">
                      <Input
                        type="text"
                        className="flex-1"
                        placeholder="Ask AI to refine this document..."
                        value={chatInput}
